...
public class TourismActivity extends Activity {
	...
	Integer[] pics = {R.drawable.akshardham_temple,
			R.drawable.ansal_plaza,
			R.drawable.appu_ghar,
			R.drawable.art_heritage,
			R.drawable.chandni_chowk,
			R.drawable.dilli_haat_ina,
			R.drawable.garhi_lalit_kala_artist_studio,
			R.drawable.greater_kailash_market,
			R.drawable.gurudwara_bangla_sahib,
			R.drawable.humayun_tomb,
			R.drawable.india_gate,
			R.drawable.indira_gandhi_memorial,
			R.drawable.iskcon_temple,
			...
			R.drawable.nehru_park,
			R.drawable.parliament_house ,
			R.drawable.pragati_maidan,
			R.drawable.purana_qila,
			R.drawable.qutab_minar ,
			R.drawable.raj_ghat,
			R.drawable.rajpath ,
			R.drawable.rashtrapati_bhavan,
			R.drawable.red_fort,
			R.drawable.the_village_gallery,
			R.drawable.tibet_house };
